...
export function prestarLibro(libroId, buscarLibroPorId) {
  ...
  if (!libro) {
    console.log(`\nNo se puede prestar. Libro con ID ${libroId} no existe.`);
    return false;
  }
  ...
  if (libro.estado === "disponible") {
    ...
    console.log(`\nPRESTADO: El libro "${libro.titulo}" (ID: ${libroId}) fue entregado.`);
    return true;
  } else {
    console.log(`\nNo se puede prestar. El libro "${libro.titulo}" ya está ${libro.estado}.`);
    return false;
  }
}
...
export function devolverLibro(libroId, buscarLibroPorId) {
  ...
  if (!libro) {
    console.log(`\nNo se puede devolver. Libro con ID ${libroId} no existe.`);
    return false;
  }
  ...
  if (libro.estado === "prestado") {
    ...
    console.log(`\nDEVUELTO: El libro "${libro.titulo}" (ID: ${libroId}) está DISPONIBLE de nuevo.`);
    return true;
  } else {
    console.log(`\nNo se puede devolver. El libro "${libro.titulo}" no estaba prestado.`);
    return false;
  }
}